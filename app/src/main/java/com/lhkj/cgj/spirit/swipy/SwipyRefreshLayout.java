...
package com.lhkj.cgj.spirit.swipy;
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    private void startProgressAlphaStartAnimation() {
        mAlphaStartAnimation = startAlphaAnimation(mProgress.getAlphaCompact(), STARTING_PROGRESS_ALPHA);
    }

    private void startProgressAlphaMaxAnimation() {
        mAlphaMaxAnimation = startAlphaAnimation(mProgress.getAlphaCompact(), MAX_ALPHA);
    }
...
//    }
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (mIsBeingDragged) {
                        ...
                        if (overscrollTop < mTotalDragDistance) {
                            ...
                            if (mProgress.getAlphaCompact() > STARTING_PROGRESS_ALPHA
                            ...
                            if (mProgress.getAlphaCompact() < MAX_ALPHA
    ...
    private void startScaleDownReturnToStartAnimation(int from,
        ...
        mFrom = from;
        if (isAlphaUsedForScale()) {
            mStartingScale = mProgress.getAlphaCompact();
        } else {
